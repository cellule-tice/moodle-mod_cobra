...
$string['corpusremovedfromselection'] = 'Corpus type removed from selection';
...
$string['textcount'] = 'Number of texts';
...
$string['privacy:metadata:cobra_clic'] = 'Information about clics made by the user when reading a text in CoBRA mode.';
$string['privacy:metadata:cobra_clic:course'] = 'The ID of the course where the user clicked a CoBRA word.';
$string['privacy:metadata:cobra_clic:lingentity'] = 'The ID of the lexicon entry the user clicked.';
$string['privacy:metadata:cobra_clic:textid'] = 'The ID of the text in which the user clicked.';
$string['privacy:metadata:cobra_clic:userid'] = 'The ID of the user who clicked a lexicon entry';
