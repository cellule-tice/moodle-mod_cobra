...
$string['cobra:edit']= 'gerer le plugin cobra';
$string['cobra:glossaryedit'] = 'gerer le glossaire';
$string['cobra:settings'] = 'gerer les parametres';
$string['cobra:stat'] = 'Statistique';
$string['cobra:myglossary'] = 'Mon Glossaire';
$string['cobraname'] = 'cobra name';
$string['cobraname_help'] = 'This is the content of the help tooltip associated with the cobraname field. Markdown syntax is supported.';
$string['cobra'] = 'cobra';
$string['pluginadministration'] = 'cobra administration';
$string['pluginname'] = 'cobra';
$string['language'] = 'langue';
$string['Collections _currently_linked_to_your_course']='Collections actuellement liees au cours';
...
$string['Never'] = 'Jamais';
$string['When_no_concordances'] = 'en l\'absence de concordances';
...
$string['No_text_to_remove'] = 'Aucun texte a supprimer';
$string['No_text_to_add'] = 'Aucun texte a ajouter';
...
$string['Collection_name_changed'] = 'Nom de la collection modifiée';
$string['Unable_to_change_collection_name'] = 'Impossible de renommer la collection';
