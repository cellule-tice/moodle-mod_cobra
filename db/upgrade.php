...
function xmldb_cobra_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the cobra
     * iself has been upgraded.
     *
     * For each upgrade block, the file cobra/version.php
    ...
    /*if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to cobra.
        ...
        upgrade_mod_savepoint(true, 2007040100, 'cobra');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to cobra.
        $table = new xmldb_table('cobra');
        ...
        // Define field timemodified to be added to cobra.
        $table = new xmldb_table('cobra');
        ...
        // Define index course (not unique) to be added to cobra.
        $table = new xmldb_table('cobra');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'cobra');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'cobra');
    }
